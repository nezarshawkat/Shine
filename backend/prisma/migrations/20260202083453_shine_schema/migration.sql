-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('poll', 'opinion', 'analysis', 'critique');

-- CreateEnum
CREATE TYPE "CommunityStatus" AS ENUM ('PUBLIC', 'PRIVATE');
...
CREATE TABLE "Community" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "status" "CommunityStatus" NOT NULL DEFAULT 'PUBLIC',
