...
router.get("/:type/:id", async (req, res) => {
  ...
  try {
    ...
    if (localOnly && normalizedType === "post") {
    ...
    if (localOnly && normalizedType === "community") {
    ...
    if (localOnly && normalizedType === "article") {
      return res.status(404).send("Article previews are not available in local SQLite mode.");
    }

    if (localOnly && normalizedType === "profile") {
    ...
    if (!preview && normalizedType === "post") {
    ...
    if (!preview && normalizedType === "community") {
    ...
    if (!preview && normalizedType === "article") {
    ...
    if (!preview && normalizedType === "profile") {
